...
Notice that we made a new variable to hold the result. Why is that important? **So that you can call back to journalism_courses as its own variables in the future, and create new variables from this that have other selections.**
...
**Answer: It's now organized by year-month-day, instead of month/day/year**
...
**Answer It is giving you all of the variables existing within different months of July.**
...
**Answer: It's adding all votes for Cox, Moore, Lashar, Wallace and write-ins and making a variable that is the share of votes that are only for Moore. This makes one column for the total votes and a column for share of votes only for Moore. By creating the total_votes column, it allows you to find the share of votes for Moore.**
...
**Answer: It organized the entire sheet by pct_moore from highest to lowest percent.**
...
**Answer: This places the smallest percentages at the top of the dataset.**
...
**Answer: str_to_lower, which makes it lowercase. also str_to_title, which capitalizes only the first letter**
...
**Answer: Yes, it makes a column that groups observations any time the address is in a specific state. It then shows you how many observations exist from the previous when_by**
...
1.  How many newspapers made payments in the Maryland expenditure data?

2.  Of the total journalism course seats, how many were for JOUR200?

3.  Of Maryland payment addresses, how many were made before July?
