...
**A1: It's a URL instead of a file in a computer's drive.**
...
**A2: 10,364 records. We can learn the timestamp and exact location of an earthquake among other measurements.**
...
**A3: The deepest earthquake is 645.729 and its magnitude is 4.20**
...
**A4: Only four earthquakes have a magnitude that is greater than 6.**
...
**A5: Three earthquakes fit this criteria.**
...
**A6: 8,145 earthquakes either have a depth smaller than 20 or magnitude larger than 6.**
...
**A7: 2,650 earthquakes were in Alaska.**
...
**A8: The two most common are earthquakes and quarry blasts.**
...
**A9: Average depth of earthquake is 21.67. Quarry blasts have a negative depth which is interesting.**
