...
**Task** Run the following code. Describe the output in the space below: what kind of information does it contain? **It details the shape and size of each data point.**
...
**Task** Run the following code. Describe the output in the space below. **It created geometrical shapes and points of each data point, the counties, and pieced them together using coordinates to piece together a county map of Maryland.**
...
**Task** Run the following code. Describe the output in the space below. What regional patterns do you see? **Most foreclosures are in the east and center of the state, whereas there aren't quite as many around the Chesapeake Bay.**
