...
**Task** Run the following code. Describe the plot. What pattern do you see? **There is a slightly positive relationship between GDP growth and population change, meaning as populations grow, GDP is also expected to increase.**
...
**Task** Run the following code. Describe the plot. What do you see? **There is a very marginally negative relationship between GDP growth and per pupil spending that is not necessarily significant.**
...
**Task** Run the following code. Describe the table output in terms of the strength of relationships between the variables. What do you see? **Per Pupil spending in 2021 has a negative relationship with GDP growth and population change, whereas GDP growth has a positive relationship with the population change.**
...
**Task** Run the following code. Describe the model output. What do you see? **This shows the statistical relationship between spending per pupil and population change in 2021, reflecting that the p-value is very low and there is a statistical significance between spending per pupil and population change.**
...
**Task** Run the following code. Describe the model output. What do you see? **The p-value is very high so there is a lower correlation between spending per pupil and GDP growth, such that the hypothesis can't necessarily be supported by the data.**
...
**Task** Run the following code. Describe the table. What do you see? **There is more economic growth and spending per pupil in states that mostly voted Biden but more population growth in states that voted for Trump.**
...
**Task** Run the following code. Describe the output. What do you see? **The t-value is negative, making it not particularly significant, and the p-value is greater than 0.05 so the hypothesis cannot necessarily be supported.**
...
**Task** Run the following code. Describe the output. What do you see? **The t-value is positive and higher now, so it is more promising and reliable. Also, the p-value is incredibly low, so there is statistically significant.**
