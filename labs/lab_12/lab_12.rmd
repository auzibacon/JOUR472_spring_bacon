...
**A1. Failing is the most common word, at 5% overall, which suggests that there was something with inadequate state support or an unmet goal. I would assume this is related to finances because the attorney mentioned accounts and funds predominantly. Also, it mentioned trust, so perhaps there was a scandal around this time as well.**
...
# Check the task 12 on Pre-lab 12 to see if you can use that code
 unique_trigrams <- md_attorney_sanctions |>
...
**A2. Attorney trust account was the most common trigram, having appeared 343 times in the text of the MD Attorney Sanctions dataframe. This means that the state official is most frequently referring to the attorney trust account and the current state of it - whether it is failing and how many funds are in the account, as this is most relevant to those concerned about the state and resources for law.**
...
```{r}
yearly_trigram <- md_attorney_sanctions |>
...
**A3. There was more need to rely on the attorney trust account or there were more issues/concerns surrounding it leading up to, during and immediately after the pandemic. However, need for the account dropped in 2023 - returning to pre-pandemic, early 2000s levels.**
