...
overdose_calls <- read_csv("tabula-Baltimore County; Carey, Samantha log OD.csv", col_names = FALSE)|> clean_names()|>
   rename(date = x1, time = x2, case_num = x3, case_type = x4, location = x5)|>
...
```{r}
calls_by_weekday <- overdose_calls |>
...
A4. I want to know the breakdown of these locations by Baltimore City neighborhoods and their proximity to recovery centers in the neighborhood. I think pointing out the status of community centers aimed at recovery would be interesting based on where most of these calls are coming from.
